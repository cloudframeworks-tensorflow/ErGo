...
import numpy as np
import os
import utils.s2s_reader as s2s_reader
...
while True:
    ...
    if reader.epoch != curr_epoch:
        ...
        print(
        "    avg loss: " + str(epoch_loss / epoch_count))
        print(
        "\n")
    ...
    if count % 10 == 0:
        print(
        str(loss_t) + " @ epoch: " + str(reader.epoch) + " count: " + str(epoch_count * batch_size))
